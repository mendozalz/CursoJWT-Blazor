using CursoJWT.Client.Pages;
using CursoJWT.Components;
using CursoJWT.Server.Data;
...
app.MapRazorComponents<App>()
    ...
    .AddAdditionalAssemblies(typeof(CursoJWT.Client._Imports).Assembly);

app.UseAuthentication(); // Asegúrate de agregar el middleware de autenticación
app.UseAuthorization();  // Asegúrate de agregar el middleware de autorización
